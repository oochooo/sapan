...
export default function OnboardingPage() {
  ...
  const subcategories =
    industries.find((c) => c.slug === selectedCategory)?.subcategories || [];
  ...
  const handleMentorSubmit = async (data: MentorForm) => {
    ...
    if (step === 2) {
      if (selectedIndustries.length === 0 || selectedObjectives.length === 0) {
        setError(
          "Please select at least one industry and one area you can help with",
        );
        return;
      }
      setStep(3);
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            Complete Your {user.user_type === "founder" ? "Founder" : "Mentor"}{" "}
            Profile
          </h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          {user.user_type === "founder" ? (
            <form
              onSubmit={founderForm.handleSubmit(handleFounderSubmit)}
              className="space-y-6"
            >
              {step === 1 && (
                <>
                  <Input
                    label="Startup Name"
                    {...founderForm.register("startup_name", {
                  ...
                  <Textarea
                    ...
                    rows={4}
                    {...founderForm.register("about_startup", {
            ...
            <form
              onSubmit={mentorForm.handleSubmit(handleMentorSubmit)}
              className="space-y-6"
            >
              {step === 1 && (
                <>
                  ...
                  <Input
                    ...
                    error={
                      mentorForm.formState.errors.years_of_experience?.message
                    }
                  />
                </>
              )}
