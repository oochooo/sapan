...
class UserConnectionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'first_name', 'last_name', 'profile_photo', 'bio', 'user_type', 'profile', 'profile_id']
    ...
    def get_profile(self, obj):
        if obj.user_type == 'founder' and hasattr(obj, 'founder_profile'):
            return {
                ...
                'industry': obj.founder_profile.industry.name if obj.founder_profile.industry else None,
            }
...
class ConnectionRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'from_user', 'from_user_detail', 'to_user', 'to_user_detail',
...
class ConnectionRequestCreateSerializer(serializers.ModelSerializer):
    ...
    def validate_to_user(self, value):
        ...
        if ConnectionRequest.objects.filter(from_user=request.user, to_user=value).exists():
            raise serializers.ValidationError("You have already sent a request to this mentor.")
        return value
