...
class FounderProfileSerializer(serializers.ModelSerializer):
    ...
    objectives_detail = ObjectiveSerializer(source='objectives', many=True, read_only=True)
    stage_display = serializers.CharField(source='get_stage_display', read_only=True)

    class Meta:
        model = FounderProfile
        fields = [
            'id', 'user', 'startup_name', 'industry', 'industry_detail',
            'stage', 'stage_display', 'objectives', 'objectives_detail',
            'about_startup', 'created_at', 'updated_at'
        ]
...
class MentorProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MentorProfile
        fields = [
            'id', 'user', 'company', 'role', 'years_of_experience',
            'expertise_industries', 'expertise_industries_detail',
            'can_help_with', 'can_help_with_detail',
...
class MentorProfileCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = MentorProfile
        fields = ['company', 'role', 'years_of_experience', 'expertise_industries', 'can_help_with']
...
class MentorListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'company', 'role', 'years_of_experience',
            'expertise_industries_detail', 'can_help_with_detail',
...
class FounderListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FounderProfile
        fields = [
            'id', 'user', 'startup_name', 'industry_detail',
            'stage', 'stage_display', 'objectives_detail', 'about_startup'
        ]
